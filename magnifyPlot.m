function magnifyPlot(xlm,ylm,pos,lwid,showAxisLabels)
...
patch('Faces',[1,2,3,4],'Vertices',v,...
    ...
    'Facecolor','k',...
    'Facealpha',0.1,...
    'Linewidth',lwid,'HandleVisibility','off');% plot rectangle
...
plot(X{ii},Y{ii},'Color',clr{ii},'LineStyle',ls{ii},...
    ...
    'MarkerIndices',1:length(Y{ii})/100:length(Y{ii})); hold on;
end
xlim(xlm); ylim(ylm); % set limits of zoomed plot
set(gca,'XColor','k', 'YColor','k');
set(gca, 'LineWidth',lwid);
